...
scr.grid(column=0, sticky='WE', columnspan=3, padx=30)
...
labelsFrame = ttk.LabelFrame(win, text='there is some labels, prisoned in a frame ')
...
ttk.Label(labelsFrame, text="Label5").grid(column=1, row=1)
ttk.Label(labelsFrame, text="Label6").grid(column=2, row=1)
